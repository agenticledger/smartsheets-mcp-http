...
<head>
  ...
  <title>Authorize \u2014 Smartsheets MCP</title>
...
<body>
  <div class="card">
    <div class="header"><img src="/static/logo.png" alt="AgenticLedger"><span>Smartsheets MCP</span></div>
    <div class="consent-msg">An application wants to connect to <strong>Smartsheets MCP Server</strong> on your behalf. Enter your API key to authorize access.</div>
